...
function Event() {
  ...
  this.subscribe = func => this.subscribers.add(func);

  this.unsubscribe = func => this.subscribers.delete(func);

  this.emit = (...args) => this.subscribers.forEach(func => func.apply(null, args));
}
...
//   emit(...args) {
//     this.subscribers.forEach(func => func.apply(null, args));
//   }
// }
