...
print(create_anagram("AABAA", "BBAAA"), 1)
print(create_anagram("OVGHK", "RPGUC"), 4)
print(create_anagram("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAB","AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAC"), 1)